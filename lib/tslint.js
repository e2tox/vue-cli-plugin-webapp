module.exports = function lint (args = {}, api, silent) {
  ...
  const program = tslint.Linter.createProgram(api.resolve('src/webapp/tsconfig.json'))
  ...
  const tslintConfigPath = api.resolve('src/webapp/tslint.json')
  ...
  const files = args._ && args._.length
    ? args._
    : ['src/webapp/**/*.ts', 'src/webapp/**/*.vue', 'src/webapp/**/*.tsx']
